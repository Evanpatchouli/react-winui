...
var r = /^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*\:/i, i = () => {}, a = ({ icon: a, text: o = "Nav Link", href: s, active: c, imgSrc: l, imgAlt: u, onClick: d = i, showBadge: f, imgBorderRadius: p, badgeBackgroundColor: m, allowJavaScriptUrls: h = !0 }) => {
